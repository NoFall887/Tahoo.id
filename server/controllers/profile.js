...
profileRouter.put('/update-user/:id', checkAuth, upload.any(), imgUpload, async (req, res, next) => {
  const userId = req.params.id
  var {username, name, email, password, passwordEdit} = req.body
  const imgUrl = req.uploadResult?.secure_url == null ? req.body.foto:req.uploadResult.secure_url
