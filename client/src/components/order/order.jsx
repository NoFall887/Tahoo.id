    ...
    <div className='shadow rounded d-grid gap-2 p-4'>
      <div className='d-flex order-item align-items-center'>
        ...
        <div className='order-text-container' >
          ...
          <FieldJumlahBarang jumlah={jumlah} onEdit={onEdit} setJumlah={setJumlah} />
        </div>
        {data.status_pesanan === 'selesai'? <Badge className='py-2' bg='success'>Selesai</Badge>:<Badge className='py-2' bg='warning'>Menunggu pembayaran</Badge>}
        <OrderEditBtn onEdit={onEdit} setOnEdit={setOnEdit} jumlah={jumlah} data={data}/>
      ...
      <div className='d-flex justify-content-between align-items-center'>
        ...
        <BuktiPembayaranBtn setShow={setShow} data={data} setChangeOrder={setChangeOrder} />
      </div>
